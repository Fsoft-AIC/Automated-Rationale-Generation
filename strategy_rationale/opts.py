...
def parse_opt():
    ...
    parser.add_argument(
        '--input_json',
        type=str,
        default='data/json/pong_strat.json',
        help='path to the json file containing video info')
    parser.add_argument(
        '--info_json',
        type=str,
        default='data/json/info.json',
        help='path to the json file containing additional info and vocab')
    parser.add_argument(
        '--caption_json',
        type=str,
        default='data/json/caption.json',
    ...
    parser.add_argument(
        ...
        nargs='*',
        type=str,
        default=['data/feats/inception_v3/pong_strat_31_3'],
    ...
    parser.add_argument(
        '--batch_size', type=int, default=150, help='minibatch size')
    parser.add_argument(
        '--grad_clip',
        type=float,
        default=5,  # 5.,
