...
if __name__ == "__main__":
    ...
    # input json
    parser.add_argument('--input_json', type=str, default='data/json/pong_strat.json',
                        help='path to json file to data info')
    parser.add_argument('--info_json', default='data/json/info_pong.json',
                        help='path to exported json about iw2word and word2ix')
    parser.add_argument('--caption_json', default='data/json/caption_pong.json', 
    help='path to exported json file about caption')
